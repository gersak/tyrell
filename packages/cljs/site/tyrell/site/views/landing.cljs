       ...
       [:div.flex.items-center.gap-3
        [:div.ty-bg-success.ty-border-success.border.p-1.rounded-full.flex-shrink-0
         [:ty-icon.ty-text++ {:name "check"
                              :size "xs"}]]
        [:div.text-left
         [:p.ty-text.text-sm.font-medium "Drops into your design system"]
       ...
       [:div.flex.items-center.gap-3
        [:div.ty-bg-success.ty-border-success.border.p-1.rounded-full.flex-shrink-0
         [:ty-icon.ty-text++ {:name "check"
                              :size "xs"}]]
        [:div.text-left
         [:p.ty-text.text-sm.font-medium "Framework-agnostic"]
       ...
       [:div.flex.items-center.gap-3
        [:div.ty-bg-success.ty-border-success.border.p-1.rounded-full.flex-shrink-0
         [:ty-icon.ty-text++ {:name "check"
                              :size "xs"}]]
        [:div.text-left
         [:p.ty-text.text-sm.font-medium "Typed React wrappers"]
       ...
       [:div.flex.items-center.gap-3
        [:div.ty-bg-success.ty-border-success.border.p-1.rounded-full.flex-shrink-0
         [:ty-icon.ty-text++ {:name "check"
                              :size "xs"}]]
        [:div.text-left
         [:p.ty-text.text-sm.font-medium "One dep, every stack"]
       ...
       [:div.flex.items-center.gap-3
        [:div.ty-bg-success.ty-border-success.border.p-1.rounded-full.flex-shrink-0
         [:ty-icon.ty-text++ {:name "check"
                              :size "xs"}]]
        [:div.text-left
         [:p.ty-text.text-sm.font-medium "3000+ icons, tree-shakeable"]
       ...
       [:div.flex.items-center.gap-3
        [:div.ty-bg-success.ty-border-success.border.p-1.rounded-full.flex-shrink-0
         [:ty-icon.ty-text++ {:name "check"
                              :size "xs"}]]
        [:div.text-left
         [:p.ty-text.text-sm.font-medium "Mobile-ready, accessible"]
